<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>List Verifikasi Data Bahasa Internasional</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?php echo base_url('beranda'); ?>">Beranda</a></li>
                        <li class="breadcrumb-item active">List Verifikasi Bahasa</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">List Verifikasi Data Bahasa Internasional</h3>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    foreach ($prodi->result() as $row) { ?>
                                        <tr>
                                            ...
                                            <td align="center"><a href="<?= base_url('bks_bahasa/detaildata/' . $row->id_prodi) ?>" class="on-default edit-row btn btn-info pull-right btn-xs"><i class="fa fa-check"></i> &nbsp; Verifikasi Data </a></td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                            </table>
