    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Lembar Bimbingan Minggu 9 - 12</h1>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Lembar Bimbingan Minggu 9 - 12</h3>
                        </div>
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($bimbingan_user912_dosen->result() as $row) :
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Lembar Bimbingan Minggu 9 - 12</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div id="custom-width-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog" style="width:55%;">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo base_url() . 'bimbingan2/add912'; ?>" method="post" class="form-horizontal" role="form">
                                    <div class="card-body">
                                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-12">
                        <div style="text-align:right;margin-bottom: 10px ">
                            ...
                            <a href="<?= site_url('bimbingan2/cetak_kartu912') ?>" type="button" class="btn btn-primary">Print</a>
                        </div>
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Ajukan Lembar Bimbingan Minggu 5 - 8</h3>
                            </div>
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
                                    ...
                                    <tbody>
                                        <?php
                                        $no = 1;
                                        foreach ($bimbingan_user912->result() as $row) { ?>
