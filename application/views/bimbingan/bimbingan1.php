                                        ...
                                        <tbody>
                                            ...
                                            foreach ($bimbingan_user->result() as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($row->status == '0') {
                                                            echo "<a onclick='return confirm('Yakin akan hapus?');' href='" . base_url('bimbingan_proposal/delete_bimbingan/' . $row->id_bimbingan) . "' id='btn-hapus' class='btn btn-danger btn-sm'>
