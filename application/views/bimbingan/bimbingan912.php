                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Daftar Lembar Bimbingan</h3>
                        </div>
                        <div class="card-body">
                    ...
                    <div id="custom-width-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog" style="width:55%;">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo base_url() . 'bimbingan1/add912'; ?>" method="post" class="form-horizontal" role="form">
                                    <div class="card-body">
                                        <div class="form-group">
                ...
                <div class="row">
                    <div class="col-12">
                        <div style="text-align:right;margin-bottom: 10px ">
                            ...
                            <a href="<?= site_url('bimbingan1/cetak_kartu912') ?>" type="button" class="btn btn-primary">Print</a>
                        </div>
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Ajukan Lembar Bimbingan Minggu 9 - 12</h3>
                            </div>
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    <thead>
