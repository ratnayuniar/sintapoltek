                      ...
                      <tr>
                        ...
                        <td>
                          <?php if ($row->st_beritaacara == 0) { ?>
                            <a href="javascript:;" data-id_seminar_proposal="<?php echo $row->id_seminar_proposal ?>" data-nim="<?php echo $row->nim ?>" data-nama="<?php echo $row->nama ?>" data-judul="<?php echo $row->judul ?>" data-toggle="modal" data-target="#modal_berita_acara">

                              <button data-toggle="modal" data-target="#ubah-data" class="btn btn-info btn-sm">Ubah</button>
                          ...
                          <?php if ($row->st_beritaacara == '0') {
                            echo " <a href='javascript:;' data-id='<?php echo $row->id_seminar_proposal ?>' data-nim='<?php echo $row->nim ?>' data-nama='<?php echo $row->nama ?>' data-judul='<?php echo $row->judul ?>' data-toggle='modal' data-target='#modal_berita_acara'>
                                <button data-toggle='modal' data-target='#ubah-data' class='btn btn-info btn-sm'>Ubah</button>
                                </a>";
                          } else if ($row->st_beritaacara == '1') {
                            echo " <a href ='#' class ='btn btn-sm btn-info btn-xs btn-block' data-toggle='modal' data-target='#modal_berita_acara' onClick=\"SetInput('" . $row->id_seminar_proposal . "','" . $row->nim . "','" . $row->nama . "','" . $row->judul . "','" . $row->catatan_beritaacara . "','" . $row->tgl_beritaacara . "')\"> Kurang</a>";
                          } else {
                            echo " <a href ='#' class ='btn btn-sm btn-success btn-xs btn-block' data-toggle='modal' data-target='#modal_berita_acara' onClick=\"SetInput('" . $row->id_seminar_proposal . "','" . $row->nim . "','" . $row->nama . "','" . $row->judul . "','" . $row->catatan_beritaacara . "','" . $row->tgl_beritaacara . "')\"> Lengkap</a>";
                          }
                          ?>
                          <?php if ($row->st_beritaacara == '0') {
                        ...
                        <td> <?php if ($row->st_persetujuan == '0') {
                                echo " <a href ='#' class ='btn btn-sm btn-warning btn-xs btn-block' data-toggle='modal' data-target='#modal_persetujuan' onClick=\"SetInput2('" . $row->id_seminar_proposal . "','" . $row->nim . "','" . $row->nama . "','" . $row->judul . "','" . $row->catatan_beritaacara . "','" . $row->tgl_beritaacara . "')\"> Belum</a>";
                              } else if ($row->st_persetujuan == '1') {
                                echo " <a href ='#' class ='btn btn-sm btn-warning btn-xs btn-block' data-toggle='modal' data-target='#modal_persetujuan' onClick=\"SetInput2('" . $row->id_seminar_proposal . "','" . $row->nim . "','" . $row->nama . "','" . $row->judul . "','" . $row->catatan_persetujuan . "','" . $row->tgl_persetujuan . "')\"> Kurang</a>";
                              } else {
                                echo " <a href ='#' class ='btn btn-sm btn-warning btn-xs btn-block' data-toggle='modal' data-target='#modal_persetujuan' onClick=\"SetInput2('" . $row->id_seminar_proposal . "','" . $row->nim . "','" . $row->nama . "','" . $row->judul . "','" . $row->catatan_persetujuan . "','" . $row->tgl_persetujuan . "')\"> Lengkap</a>";
                              }
                              ?>
                        ...
                        <td> <?php if ($row->st_proposal == '0') {
                                echo " <a href ='#' class ='btn btn-sm btn-warning btn-xs btn-block' data-toggle='modal' data-target='#modal_berita_acara' onClick=\"SetInput('" . $row->id_seminar_proposal . "','" . $row->nim . "','" . $row->nama . "')\"> Belum</a>";
          ...
          <form action="<?= base_url('bks_seminar/verif_fileta') ?>" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group row">
                <input type="hidden" id="id" name="id_seminar_proposal">
      ...
      <div class="modal-dialog" style="width:55%;">
        <div class="modal-content">
          ...
          <form action="<?= base_url('bks_seminar/verif_fileta') ?>" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
            <div class="card-body">
              <div class="form-group row">
                <input type="text" id="id_seminar_proposal" name="id_seminar_proposal">
                <label for="inputEmail3" class="col-sm-3 col-form-label">NIM</label>
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="nim" name="nim" readonly>
                </div>
