    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Detail Data Pengalaman Magang / PKL</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="<?php echo base_url('beranda'); ?>">Beranda</a></li>
                            <li class="breadcrumb-item"><a href="<?php echo base_url('bks_pkl'); ?>">Data Berkas Magang / PKL</a></li>
                            <li class="breadcrumb-item">Detail Data Berkas Magang / PKL</li>
                        </ol>
                    </div>
                </div>
            </div>
