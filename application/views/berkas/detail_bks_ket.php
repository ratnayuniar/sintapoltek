                            ...
                            <div class="invoice p-3 mb-3">
                                ...
                                <div class="row invoice-info">
                                    ...
                                    <div class="col-sm-4 invoice-col">
                                        ...
                                        ?><br>
                                        <b>Aksi</b> :
                                        <a href="<?php echo site_url('bks_keterampilan/save_bks_valid/' . $row->id_bks_ket); ?>" id="btn-konfirmasi" class="btn btn-xs btn-success">Valid</a>
                                        <a href="<?php echo site_url('bks_keterampilan/save_bks_tidakvalid/' . $row->id_bks_ket); ?>" id="btn-konfirmasi" class="btn btn-xs btn-danger">Tidak Valid</a>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <h4>
                                                    <i class="fas fa-check-circle"></i> Nama Keterampilan<br>
                                                    <input type="text" class="form-control col-sm-8" value="<?= $row->nama_ket ?>" readonly><br>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <iframe type="application/pdf" src="<?php echo base_url('assets/berkas/keterampilan/' . $row->sk_ket); ?>" width="100%" height="600"></iframe><br>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
