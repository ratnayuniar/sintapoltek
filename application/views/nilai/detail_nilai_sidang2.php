<?php if (($this->session->userdata('level') == 3) || ($this->session->userdata('level') == 4)) { ?>
                    ...
                    <div class="col-5">
                        <div class="card card-info ">
                            <div class="card-header">
                                <h3 class="card-title">Data Nilai Sidang Tugas Akhir</h3>
                            </div>
                            <form action="<?php echo base_url() . 'nilai_sidang/add'; ?>" method="post" class="form-horizontal" role="form">
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-5 col-form-label">Hasil TA</label>
                                        <div class="col-sm-5">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input readonly type="text" class="form-control" id="rata_rata" name="rata" placeholder="Nilai rata rata " value="<?php if (empty($result->rata)) echo "";
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="number" class="form-control " id="nilai" name="nilai_akhir" value="<?php if (empty($result->nilai_akhir)) echo "";
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#perumusan, #teori, #pemecahan, #penulisan, #pustaka,#karya, #presentasi, #penguasaan").keyup(function() {
                ...
                var nilai_akhir = ((parseInt(rata_rata) * 3) + (2 * parseInt(presentasi)) + (2 * parseInt(penguasaan) + (3 * parseInt(karya)))) / 10;
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">Data Nilai Penguji <?php echo $data['namadosen']->nama ?> Sidang Tugas Akhir</h3>
                                </div>
