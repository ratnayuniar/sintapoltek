  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Nilai Seminar Proposal</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo base_url('beranda'); ?>">Beranda</a></li>
              <li class="breadcrumb-item active">Data Nilai Seminar Proposal</li>
            </ol>
          </div>
        </div>
      </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                        <?php if (empty($result->rata)) echo "";
                            else echo $result->rata ?>
                            </td>
                        <td>
                        <?php if (empty($result->nilai_akhir)) echo "";
                            else echo $result->nilai_akhir ?>
                            </td>
                        <td>
                          ...
                          <a href="<?= base_url('nilai_seminar/detail_nilai_seminar2/' . $row->nim); ?>" class="on-default edit-row btn btn-primary btn-xs"> Input Nilai</a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
