                    ...
                    <div class="row">
                        <div class="col-4">
                            <div class="card card-info">
                                ...
                                <?php echo form_open_multipart('revisi_upload_seminar/upload_berkas'); ?>
                                <div class="card-body">
                        ...
                        <?php if ($ambilBerkas['file_revisi']  != "") { ?>
                            <div class="col-8">
                                <div class="card card-success">
                                    ...
                                    <div class="card-body">
                                        <iframe type="application/pdf" src="<?= base_url('') ?>assets/berkas/seminar/<?= $ambilBerkas['file_revisi']; ?>" width="100%" height="600"></iframe><br>
                                    </div>
                                </div>
                            </div>
                        <?php } else { ?>
