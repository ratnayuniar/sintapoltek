...
class Bimbingan2 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('bimbingan/list_bimbingan2', $data);
    ...
    public function minggu58()
    {
        ...
        $data['query'] = $this->m_bimbingan2->tampil_data();
        $data['bimbingan_user58'] = $this->m_bimbingan2->bimbingan_user58();
        $data['bimbingan_user58_dosen'] = $this->m_bimbingan2->bimbingan_user58_dosen();
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('bimbingan/bimbingan58_2', $data);
        $this->load->view('templates/footer', $data);
    }
    ...
    {
        $data['query'] = $this->m_bimbingan2->tampil_data();
        $data['bimbingan_user912'] = $this->m_bimbingan2->bimbingan_user912();
        $data['bimbingan_user912_dosen'] = $this->m_bimbingan2->bimbingan_user912_dosen();
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('bimbingan/bimbingan912_2', $data);
        $this->load->view('templates/footer', $data);
    }
    ...
    public function minggu1316()
    {
        ...
        $data['query'] = $this->m_bimbingan2->tampil_data();
        $data['bimbingan_user1316'] = $this->m_bimbingan2->bimbingan_user1316();
        $data['bimbingan_user1316_dosen'] = $this->m_bimbingan2->bimbingan_user1316_dosen();
        ...
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar', $data);
        $this->load->view('bimbingan/bimbingan1316_2', $data);
        $this->load->view('templates/footer', $data);
    }
    ...
    public function add58()
    {
        ...
        if (empty($id_bimbingan)) $this->m_bimbingan2->tambah_data58();
        else $this->m_bimbingan2->ubah_data($id_bimbingan);
    }
    ...
    public function add912()
    {
        ...
        if (empty($id_bimbingan)) $this->m_bimbingan2->tambah_data912();
        else $this->m_bimbingan2->ubah_data($id_bimbingan);
    }
    ...
    public function add1316()
    {
        ...
        if (empty($id_topik)) $this->m_bimbingan2->tambah_data1316();
        else $this->m_bimbingan2->ubah_data($id_topik);
    }
    ...
    function save_komentar()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            // $this->m_bimbingan2->insert_komentar($data);
    ...
    function cetak_kartu()
    {
        ...
        $this->mypdf->generate('bimbingan/dompdf', $data);
    }
